        ...
        <Row>
          <Col xs='12' md='6'>
            ...
            <Card>
              ...
              <CardBody>
                ...
                <Button color='secondary'><i className='fa fa-lightbulb-o' />{'\u00A0 Secondary'}</Button>
          ...
          <Col xs='12' md='6'>
            ...
            <Card>
              ...
              <CardBody>
                <Button outline color='primary'><i className='fa fa-star' />&nbsp; Primary</Button>
                <Button outline color='secondary'><i className='fa fa-lightbulb-o' />&nbsp; Secondary</Button>
                <Button outline color='success'><i className='fa fa-magic' />&nbsp; Success</Button>
                <Button outline color='warning'><i className='fa fa-map-marker' />&nbsp; Warning</Button>
