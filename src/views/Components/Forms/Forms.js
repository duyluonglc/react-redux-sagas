                  ...
                  <FormGroup row>
                    <Col md='12'>
                      <InputGroup>
                        ...
                        <InputGroupAddon><i className='fa fa-envelope-o' /></InputGroupAddon>
                      </InputGroup>
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    <Col md='12'>
                      <InputGroup>
                        <InputGroupAddon><i className='fa fa-euro' /></InputGroupAddon>
                ...
                <Form action='' method='post' className='form-horizontal'>
                  <FormGroup row>
                    <Col md='12'>
                      <InputGroup>
                        <InputGroupButton>
                          <Button color='primary'><i className='fa fa-search' /> Search</Button>
                        </InputGroupButton>
                  ...
                  <FormGroup row>
                    <Col md='12'>
                      <InputGroup>
                        <InputGroupButton>
                          <Button color='primary'><i className='fa fa-facebook' /></Button>
                        </InputGroupButton>
                        <Input type='text' id='input3-group2' name='input3-group2' placeholder='Search' />
                        <InputGroupButton>
                          <Button color='primary'><i className='fa fa-twitter' /></Button>
                        </InputGroupButton>
                      </InputGroup>
                    </Col>
                  </FormGroup>
                ...
                <Form action='' method='post'>
                  ...
                  <FormGroup>
                    <InputGroup>
                      ...
                      <InputGroupAddon><i className='fa fa-asterisk' /></InputGroupAddon>
                    </InputGroup>
                  </FormGroup>
